...
import com.javaparainiciantes.boot.pix.model.Cob;
import com.javaparainiciantes.boot.pix.model.CobBaseInfoAdicionais;
import com.javaparainiciantes.boot.pix.model.CobBaseValor;
import com.javaparainiciantes.boot.pix.model.CobExpiracao;
 ...
 */
@JsonPropertyOrder({
  CobCompleta.JSON_PROPERTY_CALENDARIO,
  CobCompleta.JSON_PROPERTY_STATUS,
  CobCompleta.JSON_PROPERTY_TXID,
  CobCompleta.JSON_PROPERTY_REVISAO,
  CobCompleta.JSON_PROPERTY_LOCATION,
  CobCompleta.JSON_PROPERTY_DEVEDOR,
  CobCompleta.JSON_PROPERTY_VALOR,
  CobCompleta.JSON_PROPERTY_CHAVE,
  CobCompleta.JSON_PROPERTY_SOLICITACAO_PAGADOR,
  CobCompleta.JSON_PROPERTY_INFO_ADICIONAIS,
  CobCompleta.JSON_PROPERTY_PIX
})
...
public class CobCompleta {
  ...
  public CobCompleta calendario(CobExpiracao calendario) {
  ...
  **/
  ...
  public CobCompleta status(CobStatus status) {
  ...
  **/
  ...
  public CobCompleta txid(String txid) {
  ...
  **/
  ...
  public CobCompleta revisao(Integer revisao) {
  ...
  **/
  ...
  public CobCompleta location(URI location) {
  ...
  **/
  ...
  public CobCompleta devedor(Pessoa devedor) {
  ...
  **/
  ...
  public CobCompleta valor(CobBaseValor valor) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(calendario, status, txid, revisao, location, devedor, valor, chave, solicitacaoPagador, infoAdicionais, pix);
  }
