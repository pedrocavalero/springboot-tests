...
import com.pedrocavalero.pix.client.model.Violacao;
...
public class Problema {
  ...
  private List<Violacao> violacoes = null;

  public Problema type(String type) {
    this.type = type;
    return this;
  }
   ...
   * @return type
  **/
  @Schema(example = "https://pix.bcb.gov.br/api/v2/error/NaoEncontrado", required = true, description = "URI de referência que identifica o tipo de problema. De acordo com a RFC 7807.")
  ...
  public Problema title(String title) {
    this.title = title;
    return this;
  }
   ...
   * @return title
  **/
  @Schema(example = "Not found", required = true, description = "Descrição resumida do problema.")
   ...
   * @return status
  **/
  @Schema(example = "404", required = true, description = "Código HTTP do status retornado.")
  ...
  public Problema detail(String detail) {
    this.detail = detail;
    return this;
  }
  ...
  **/
  ...
  public Problema correlationId(String correlationId) {
  ...
  **/
  ...
  public Problema violacoes(List<Violacao> violacoes) {
