...
import com.pedrocavalero.pix.client.model.CobBase;
import com.pedrocavalero.pix.client.model.CobBaseInfoAdicionais;
import com.pedrocavalero.pix.client.model.CobVPayloadValor;
import com.pedrocavalero.pix.client.model.DadosRecebedor;
 ...
 */
@Schema(description = "Dados da cobrança com vencimento acessados pelo payload JSON")
...
public class CobVPayload {
  ...
  @JsonProperty("valor")
  private CobVPayloadValor valor = null;

  public CobVPayload recebedor(Object recebedor) {
   ...
   * @return recebedor
  **/
  @Schema(required = true, description = "O objeto recebedor organiza as informações sobre o credor da cobrança.")
  public Object getRecebedor() {
    return recebedor;
  }

  public void setRecebedor(Object recebedor) {
    this.recebedor = recebedor;
  }

  public CobVPayload chave(String chave) {
    this.chave = chave;
    return this;
  }
   ...
   * @return chave
  **/
  @Schema(required = true, description = "# Formato do campo chave  * O campo chave determina a chave Pix registrada no DICT que será utilizada para a cobrança. Essa chave será lida pelo aplicativo do PSP do pagador para consulta ao DICT, que retornará a informação que identificará o recebedor da cobrança. * Os tipos de chave podem ser: telefone, e-mail, cpf/cnpj ou EVP. * O formato das chaves pode ser encontrado na seção \"Formatação das chaves do DICT no BR Code\" do [Manual de Padrões para iniciação do Pix](https://www.bcb.gov.br/estabilidadefinanceira/pagamentosinstantaneos). ")
  ...
  public CobVPayload solicitacaoPagador(String solicitacaoPagador) {
  ...
  **/
  ...
  public CobVPayload infoAdicionais(List<CobBaseInfoAdicionais> infoAdicionais) {
    this.infoAdicionais = infoAdicionais;
    return this;
  }

  public CobVPayload addInfoAdicionaisItem(CobBaseInfoAdicionais infoAdicionaisItem) {
  ...
  **/
  ...
  public CobVPayload devedor(Object devedor) {
   ...
   * @return devedor
  **/
  @Schema(required = true, description = "Os campos aninhados sob o objeto devedor são opcionais e identificam o devedor, ou seja, a pessoa ou a instituição a quem a cobrança está endereçada. Não identifica, necessariamente, quem irá efetivamente realizar o pagamento. Um CPF pode ser o devedor de uma cobrança, mas pode acontecer de outro CPF realizar, efetivamente, o pagamento do documento. Não é permitido que o campo devedor.cpf e campo devedor.cnpj estejam preenchidos ao mesmo tempo. Se o campo devedor.cnpj está preenchido, então o campo devedor.cpf não pode estar preenchido, e vice-versa. Se o campo devedor.nome está preenchido, então deve existir ou um devedor.cpf ou um campo devedor.cnpj preenchido.")
  ...
  public CobVPayload txid(String txid) {
    this.txid = txid;
    return this;
  }
  ...
  **/
  ...
  public CobVPayload revisao(Integer revisao) {
  ...
  **/
  ...
  public CobVPayload status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public CobVPayload valor(CobVPayloadValor valor) {
    this.valor = valor;
    return this;
  }
  ...
  **/
  ...
  public void setValor(CobVPayloadValor valor) {
    this.valor = valor;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(recebedor, chave, solicitacaoPagador, infoAdicionais, devedor, txid, revisao, status, valor);
  }
