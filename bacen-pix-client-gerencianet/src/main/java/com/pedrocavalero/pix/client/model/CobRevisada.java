...
import com.pedrocavalero.pix.client.model.CobValor;
 ...
 */
@Schema(description = "Dados enviados para revisão da cobrança imediata via API Pix")
...
public class CobRevisada {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(chave, solicitacaoPagador, infoAdicionais, devedor, loc, status, valor);
  }
