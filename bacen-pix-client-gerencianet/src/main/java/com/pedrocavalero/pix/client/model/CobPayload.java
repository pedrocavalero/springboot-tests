...
import com.pedrocavalero.pix.client.model.CobPayloadValor;
 ...
 */
@Schema(description = "Dados da cobrança imediata acessados pelo payload JSON")
...
public class CobPayload {
  ...
  @JsonProperty("valor")
  private CobPayloadValor valor = null;
  ...
  **/
  ...
  public CobPayload valor(CobPayloadValor valor) {
    this.valor = valor;
    return this;
  }
  ...
  **/
  ...
  public void setValor(CobPayloadValor valor) {
    this.valor = valor;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(chave, solicitacaoPagador, infoAdicionais, devedor, status, valor);
  }
