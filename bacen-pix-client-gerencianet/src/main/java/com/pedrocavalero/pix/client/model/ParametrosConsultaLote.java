...
public class ParametrosConsultaLote {
  ...
  public ParametrosConsultaLote inicio(OffsetDateTime inicio) {
    this.inicio = inicio;
    return this;
  }
  ...
  **/
  ...
  public ParametrosConsultaLote fim(OffsetDateTime fim) {
    this.fim = fim;
    return this;
  }
  ...
  **/
  ...
  public ParametrosConsultaLote paginacao(Paginacao paginacao) {
