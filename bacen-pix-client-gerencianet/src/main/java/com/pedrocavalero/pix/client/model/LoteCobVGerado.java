...
public class LoteCobVGerado {
  ...
  @JsonProperty("cobsv")
  private List<CobVGerada> cobsv = new ArrayList<CobVGerada>();

  public LoteCobVGerado id(Long id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public LoteCobVGerado descricao(String descricao) {
  ...
  **/
  ...
  public LoteCobVGerado criacao(OffsetDateTime criacao) {
  ...
  **/
  ...
  public LoteCobVGerado cobsv(List<CobVGerada> cobsv) {
    this.cobsv = cobsv;
    return this;
  }
  ...
  **/
  ...
  public void setCobsv(List<CobVGerada> cobsv) {
    this.cobsv = cobsv;
  }
