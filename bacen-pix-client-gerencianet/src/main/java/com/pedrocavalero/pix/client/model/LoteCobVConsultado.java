...
import com.pedrocavalero.pix.client.model.LoteCobVConsultadoCobsv;
...
public class LoteCobVConsultado {
  ...
  @JsonProperty("cobsv")
  private List<LoteCobVConsultadoCobsv> cobsv = new ArrayList<LoteCobVConsultadoCobsv>();

  public LoteCobVConsultado id(Long id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public LoteCobVConsultado descricao(String descricao) {
  ...
  **/
  ...
  public LoteCobVConsultado criacao(OffsetDateTime criacao) {
   ...
   * @return criacao
  **/
  @Schema(required = true, description = "Timestamp que indica o momento em que foi criado o lote. Respeita o formato definido na RFC 3339.")
  ...
  public LoteCobVConsultado cobsv(List<LoteCobVConsultadoCobsv> cobsv) {
    this.cobsv = cobsv;
    return this;
  }

  public LoteCobVConsultado addCobsvItem(LoteCobVConsultadoCobsv cobsvItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<LoteCobVConsultadoCobsv> getCobsv() {
    return cobsv;
  }

  public void setCobsv(List<LoteCobVConsultadoCobsv> cobsv) {
    this.cobsv = cobsv;
  }
