...
import com.pedrocavalero.pix.client.model.CobExpiracao;
...
import com.pedrocavalero.pix.client.model.PessoaFisica;
...
public class CobApiTest {
     ...
     */
    @Test
    public void cobGetTest() {
        OffsetDateTime inicio = OffsetDateTime.now().minusDays(2);
     ...
     */
    @Test
    public void cobPostTest() {
        CobSolicitada body = null;
        CobGerada response = api.cobPost(body);
     ...
     */
    @Test
    public void cobTxidGetTest() {
        String txid = "123456789012345678901234540";
     ...
     */
    @Test
    public void cobTxidPutTest() {
        CobSolicitada body = new CobSolicitada();
        body.setChave("bb4e347b-2861-4760-b88a-703e3d861d2d");
        PessoaFisica pf = new PessoaFisica().cpf("12345678910").nome("Joao da Silva");
        body.setDevedor(pf);
        CobVValor valor = new CobVValor().original("1.03");
        body.setValor(valor);
        body.setCalendario(new CobExpiracao().expiracao(3600));
        String txid = "123456789012345678901234540";
        CobGerada response;
		try {
			response = api.cobTxidPut(body, txid);
			System.out.println(response);
		} catch (RestClientException e) {
			System.out.println(((HttpClientErrorException) e).getResponseBodyAsString());
			System.out.println(((HttpClientErrorException) e).getResponseHeaders());
			e.printStackTrace();
		}
