 ...
 */
@Schema(description = "Dados enviados para criação ou alteração da cobrança imediata via API Pix")
...
public class CobSolicitada {
  ...
  **/
  ...
  public CobSolicitada valor(Object valor) {
    this.valor = valor;
    return this;
  }
...
@Override
  ...
  @Override
  public int hashCode() {
    return Objects.hash(calendario, chave, solicitacaoPagador, infoAdicionais, devedor, loc, valor);
  }
