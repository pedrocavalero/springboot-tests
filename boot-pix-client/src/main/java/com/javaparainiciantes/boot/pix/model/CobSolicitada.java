 ...
 */
@ApiModel(description = "Dados enviados para criação ou alteração da cobrança via API Pix")
@JsonPropertyOrder({
  CobSolicitada.JSON_PROPERTY_CALENDARIO,
  CobSolicitada.JSON_PROPERTY_DEVEDOR,
  CobSolicitada.JSON_PROPERTY_VALOR,
  CobSolicitada.JSON_PROPERTY_CHAVE,
  CobSolicitada.JSON_PROPERTY_SOLICITACAO_PAGADOR,
  CobSolicitada.JSON_PROPERTY_INFO_ADICIONAIS
})
...
public class CobSolicitada {
  ...
  public CobSolicitada calendario(CobExpiracao calendario) {
  ...
  **/
  ...
  public CobSolicitada devedor(Pessoa devedor) {
  ...
  **/
  ...
  public CobSolicitada valor(CobBaseValor valor) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.calendario, cobSolicitada.calendario) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(calendario, devedor, valor, chave, solicitacaoPagador, infoAdicionais);
  }
