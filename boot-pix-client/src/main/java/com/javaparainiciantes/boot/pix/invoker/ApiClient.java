...
import com.javaparainiciantes.boot.pix.invoker.auth.ApiKeyAuth;
import com.javaparainiciantes.boot.pix.invoker.auth.Authentication;
import com.javaparainiciantes.boot.pix.invoker.auth.HttpBasicAuth;
import com.javaparainiciantes.boot.pix.invoker.auth.HttpBearerAuth;
import com.javaparainiciantes.boot.pix.invoker.auth.OAuth;
...
@Component("com.javaparainiciantes.boot.pix.invoker.ApiClient")
public class ApiClient {
    ...
    private String basePath = "http://127.0.0.1:4010";
...
//    }
    ...
    protected void init() {
        ...
        oauth.setAccessToken("eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJ5UF93QVVCT3IwLXA3WDREQ09XS0sxVC1DYk54dkIyLXpjTWkwV1p0aktVIn0..BRkGUiG23DABlIv8fa3k7B0Z9G6_a2JitdgzyITixzRUGU_FXwyvdmJ49TNf6pvPHsq4AdxTCnUmWEFX-HxooBCJXUDXwp_k2m2ZUh4TETA8FNhT0_gU6lMB7YD2G6XHrof34nP63FgIapcBdK7toqV4213LLIs0gM5eD2gaGEvBKKLPFKO-CmjszAF6bFyGUH_-6xrr_iFFWQnETKgr7x_7c-U_Ge6ivvKgehisiwxmbW9qmstGPDrZKvqK3i4EP17-nrhrShrTojtXY7d0F_WqiuICdhuEf4Cl411H-Cw6fOmnwbMq7L2vuQrZbehjIWhGIZv9mZUYWJEET15QXg");
