...
import com.pedrocavalero.pix.client.model.CobVValor;
 ...
 */
@Schema(description = "Dados enviados para revisão da cobrança com vencimento via API Pix")
...
public class CobVRevisada {
  ...
  @JsonProperty("valor")
  private CobVValor valor = null;

  public CobVRevisada devedor(Object devedor) {
  ...
  **/
  ...
  public CobVRevisada chave(String chave) {
    this.chave = chave;
    return this;
  }
   ...
   * @return chave
  **/
  @Schema(description = "# Formato do campo chave  * O campo chave determina a chave Pix registrada no DICT que será utilizada para a cobrança. Essa chave será lida pelo aplicativo do PSP do pagador para consulta ao DICT, que retornará a informação que identificará o recebedor da cobrança. * Os tipos de chave podem ser: telefone, e-mail, cpf/cnpj ou EVP. * O formato das chaves pode ser encontrado na seção \"Formatação das chaves do DICT no BR Code\" do [Manual de Padrões para iniciação do Pix](https://www.bcb.gov.br/estabilidadefinanceira/pagamentosinstantaneos). ")
  ...
  public CobVRevisada solicitacaoPagador(String solicitacaoPagador) {
  ...
  **/
  ...
  public CobVRevisada infoAdicionais(List<CobBaseInfoAdicionais> infoAdicionais) {
    this.infoAdicionais = infoAdicionais;
    return this;
  }

  public CobVRevisada addInfoAdicionaisItem(CobBaseInfoAdicionais infoAdicionaisItem) {
  ...
  **/
  ...
  public CobVRevisada loc(Object loc) {
    this.loc = loc;
    return this;
  }
  ...
  **/
  ...
  public CobVRevisada status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public CobVRevisada valor(CobVValor valor) {
    this.valor = valor;
    return this;
  }
  ...
  **/
  ...
  public void setValor(CobVValor valor) {
    this.valor = valor;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.devedor, cobVRevisada.devedor) &&
        Objects.equals(this.chave, cobVRevisada.chave) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(devedor, chave, solicitacaoPagador, infoAdicionais, loc, status, valor);
  }
