...
public class ParametrosConsultaPayloadLocation {
  ...
  public enum TipoCobEnum {
    ...
    @JsonCreator
    public static TipoCobEnum fromValue(String text) {
  ...
  private TipoCobEnum tipoCob = null;
  ...
  **/
  ...
  public ParametrosConsultaPayloadLocation tipoCob(TipoCobEnum tipoCob) {
  ...
  **/
  ...
  public void setTipoCob(TipoCobEnum tipoCob) {
    this.tipoCob = tipoCob;
  }
