 ...
 */
@Schema(description = "Parâmetros utilizados para a realização de uma consulta de Webhooks.")
...
public class ParametrosConsultaWebhooks {
  ...
  public ParametrosConsultaWebhooks inicio(OffsetDateTime inicio) {
    this.inicio = inicio;
    return this;
  }
   ...
   * @return inicio
  **/
  @Schema(example = "2020-01-01T00:00Z", description = "Data inicial utilizada na consulta. Respeita RFC 3339.")
  ...
  public ParametrosConsultaWebhooks fim(OffsetDateTime fim) {
    this.fim = fim;
    return this;
  }
   ...
   * @return fim
  **/
  @Schema(example = "2020-12-01T17:00Z", description = "Data de fim utilizada na consulta. Respeita RFC 3339.")
  ...
  public ParametrosConsultaWebhooks paginacao(Paginacao paginacao) {
