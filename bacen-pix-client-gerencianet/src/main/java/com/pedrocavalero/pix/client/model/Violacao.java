...
public class Violacao {
  ...
  public Violacao razao(String razao) {
    this.razao = razao;
    return this;
  }
   ...
   * @return razao
  **/
  @Schema(example = "Valor da cobrança não pode ser 0.00", description = "Descrição do erro")
  ...
  public Violacao propriedade(String propriedade) {
   ...
   * @return propriedade
  **/
  @Schema(example = "cob.chave", description = "Nome da propriedade")
  ...
  public Violacao valor(String valor) {
    this.valor = valor;
    return this;
  }
   ...
   * @return valor
  **/
  @Schema(example = "061996671234", description = "Valor da propriedade")
