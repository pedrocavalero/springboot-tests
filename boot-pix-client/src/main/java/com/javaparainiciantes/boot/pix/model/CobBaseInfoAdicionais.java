 ...
 */
@JsonPropertyOrder({
  CobBaseInfoAdicionais.JSON_PROPERTY_NOME,
  CobBaseInfoAdicionais.JSON_PROPERTY_VALOR
})
...
public class CobBaseInfoAdicionais {
   ...
   * @return nome
  **/
  @ApiModelProperty(required = true, value = "Nome do campo.")
   ...
   * @return valor
  **/
  @ApiModelProperty(required = true, value = "Dados do campo.")
