...
import com.pedrocavalero.pix.client.model.DevolucaoHorario;
...
public class Devolucao {
  ...
  **/
  ...
  public Devolucao motivo(String motivo) {
    this.motivo = motivo;
    return this;
  }
   ...
   * @return motivo
  **/
  @Schema(description = "# Status da Devolução  Campo opcional que pode ser utilizado pelo PSP recebedor para detalhar os motivos de a devolução ter atingido o status em questão. Pode ser utilizado, por exemplo, para detalhar o motivo de a devolução não ter sido realizada.           ")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, rtrId, valor, horario, status, motivo);
  }
