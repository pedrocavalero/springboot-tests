...
import com.pedrocavalero.pix.client.model.Paginacao;
...
public class ParametrosConsultaPix {
   ...
   * @return inicio
  **/
  @Schema(example = "2020-01-01T00:00Z", required = true, description = "Data inicial utilizada na consulta. Respeita RFC 3339.")
   ...
   * @return fim
  **/
  @Schema(example = "2020-12-01T17:00Z", required = true, description = "Data de fim utilizada na consulta. Respeita RFC 3339.")
  ...
  public ParametrosConsultaPix txid(AllOfParametrosConsultaPixTxid txid) {
    this.txid = txid;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public AllOfParametrosConsultaPixTxid getTxid() {
    return txid;
  }

  public void setTxid(AllOfParametrosConsultaPixTxid txid) {
    this.txid = txid;
  }
  ...
  **/
  ...
  public ParametrosConsultaPix devolucaoPresente(Boolean devolucaoPresente) {
  ...
  **/
  @Schema(description = "Filtro pela existência de devolução.")
  public Boolean isDevolucaoPresente() {
    return devolucaoPresente;
  }

  public void setDevolucaoPresente(Boolean devolucaoPresente) {
    this.devolucaoPresente = devolucaoPresente;
  }
