 ...
 */
@Schema(description = "Todos os campos que indicam valores monetários obedecem ao formato do ID 54 da especificação EMV/BR Code para QR Codes. O separador decimal é o caractere ponto. Não é aplicável utilizar separador de milhar. Exemplos de valores aderentes ao padrão: “1.00”, “123.99”, “123456789.23")
...
public class CobVPayloadValor {
  ...
  @JsonProperty("juros")
  private String juros = null;

  @JsonProperty("abatimento")
  private String abatimento = null;
  ...
  public CobVPayloadValor original(String original) {
  ...
  **/
  ...
  public CobVPayloadValor multa(String multa) {
    this.multa = multa;
    return this;
  }
  ...
  **/
  ...
  public CobVPayloadValor juros(String juros) {
    this.juros = juros;
    return this;
  }
  ...
  **/
  ...
  public CobVPayloadValor abatimento(String abatimento) {
  ...
  **/
  ...
  public CobVPayloadValor desconto(String desconto) {
  ...
  **/
  ...
  public CobVPayloadValor _final(String _final) {
    this._final = _final;
    return this;
  }
   ...
   * @return _final
  **/
  @Schema(required = true, description = "Valor final da cobrança.")
