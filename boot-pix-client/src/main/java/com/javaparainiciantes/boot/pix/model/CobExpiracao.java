 ...
 */
@JsonPropertyOrder({
  CobExpiracao.JSON_PROPERTY_EXPIRACAO
})
...
public class CobExpiracao {
  public static final String JSON_PROPERTY_EXPIRACAO = "expiracao";
  ...
  **/
  @Nullable
  @ApiModelProperty(example = "3600", value = "Tempo de vida da cobrança, especificado em segundos a partir da data de criação (Calendario.criacao) ")
  @JsonProperty(JSON_PROPERTY_EXPIRACAO)
