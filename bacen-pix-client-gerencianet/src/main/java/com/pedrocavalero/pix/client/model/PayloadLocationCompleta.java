...
public class PayloadLocationCompleta {
  ...
  public PayloadLocationCompleta id(Long id) {
    this.id = id;
    return this;
  }
  ...
  **/
   ...
   * @return location
  **/
  @Schema(example = "pix.example.com/qr/v2/2353c790eefb11eaadc10242ac120002", required = true, description = "Localização do Payload a ser informada na criação da cobrança.")
  public String getLocation() {
    return location;
  }

  public PayloadLocationCompleta tipoCob(TipoCobEnum tipoCob) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, txid, location, tipoCob, criacao);
  }
